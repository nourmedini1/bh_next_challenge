...
import { BsBookmark, BsArrowClockwise, BsExclamationTriangle } from 'react-icons/bs';
...
const Terms = () => {
  ...
  return (
    <Container fluid className="py-4">
          ...
          <div className="d-flex justify-content-between align-items-center mb-3">
            <div>
              ...
              <p style={{ color: colors.textSecondary }} className="mb-0">
                Define and manage terminology and synonyms
              </p>
            </div>
            <Button 
      ...
      <TermsManager baseUrl={BASE_URL} apiStatus={apiStatus} />
    </Container>
  );
};

...
import { BsTag, BsArrowClockwise, BsExclamationTriangle } from 'react-icons/bs';
...
const Tags = () => {
  ...
  return (
    <Container fluid className="py-4">
          ...
          <div className="d-flex justify-content-between align-items-center mb-3">
            <div>
              ...
              <p style={{ color: colors.textSecondary }} className="mb-0">
                Create and manage tags for organizing content
              </p>
            </div>
            <Button 
      ...
      <TagsManager baseUrl={BASE_URL} apiStatus={apiStatus} />
    </Container>
  );
};
